...
SECRET_KEY = '@383u95sszlv914-=a8n^=9!ewfap=uh!ch!08w##3tfobi*v2'
...
ASGI_APPLICATION = 'realtime.routing.application'  # Usando ASGI, pois WSGI não suporta apps em realtime
